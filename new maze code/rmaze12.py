...
def main():
    ...
    while running:
        ...
        draw_centered_text(f"Round 1 Steps: {round_steps[0]}", center_1, text_y_pos)
        ...
        draw_centered_text(f"Round 2 Steps: {round_steps[1]}", center_2, text_y_pos)
        ...
        draw_centered_text(f"Round 3 Steps: {round_steps[2]}", center_3, text_y_pos)
        ...
        draw_centered_text(f"Absolute Shortest Path: {perfect_len} steps", center_4, text_y_pos)
